...
| 设备执行 | [`gpu_worker.py`](https://github.com/vllm-project/vllm/blob/61141ed265bfef41a0ca19e992567ea980919b96/vllm/v1/worker/gpu_worker.py#L130)、[`gpu_model_runner.py`](https://github.com/vllm-project/vllm/blob/61141ed265bfef41a0ca19e992567ea980919b96/vllm/v1/worker/gpu_model_runner.py#L446) | 权重、输入张量、KV 和采样如何落到 GPU？ |
...
再给每个箭头标注是否跨进程、传递什么对象。能做到，就可以进入[一条请求的生命周期](../internals/request-lifecycle)。
